...
enum class MedunderskriverFlyt(
...
class MedunderskriverflytConverter : AttributeConverter<MedunderskriverFlyt, String?> {
    override fun convertToDatabaseColumn(entity: MedunderskriverFlyt?): String? = entity?.id

    override fun convertToEntityAttribute(id: String?): MedunderskriverFlyt? = id?.let { MedunderskriverFlyt.of(it) }
}
