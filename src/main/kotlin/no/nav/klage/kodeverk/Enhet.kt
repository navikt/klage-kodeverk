...
enum class Enhet(override val id: String, override val navn: String, override val beskrivelse: String) : Kode {
    ...
    E4450("24", "4450", "Nav arbeid og ytelser - dagpenger"),
    E4470("25", "4470", "Nav arbeid og ytelser Innlandet - EØS dagpenger"),
    E4462("E4462", "4462", "Nav arbeid og ytelser - tilleggsstønad"),
    E4465("26", "4465", "Nav arbeid og ytelser Trondheim - DP grensearb"),
    ...
    E1208("201", "1208", "Nav Bergen sentrum"),
    E1209("202", "1209", "Nav Bergenhus - utgått"),
    ...
    E4280("500", "4280", "Klageinstans - Tilleggsstønader - Inn"),
    E4260("503", "4260", "Klageinstans - arbeidsavklaringspenger - inn"),
    E4270("504", "4270", "Klageinstans - dagpenger - inn"),
    E4295("505", "4295", "Klageinstans Tromsø"),
    E4286("506", "4286", "Klageinstans - uføretrygd - inn"),
    E4290("E4290", "4290", "IT-avdelingen"),
    E4293("508", "4293", "Klageinstans Tønsberg"),
    E4294("513", "4294", "Klageinstans Bergen"),
    E4292("514", "4292", "Klageinstans Trondheim"),
    E4291("515", "4291", "Klageinstans Oslo"),
    E4250("519", "4250", "Klageinstans Kristiansand"),
    E4251("E4251", "4251", "Klageinstans - bidrag - inn"),
    E4255("E4255", "4255", "Klageinstans - tiltakspenger - inn"),
    E4258("E4258", "4258", "Klageinstans - tiltak"),
    ...
    E4200("527", "4200", "Klageinstans styringsenhet"),
    ...
    E2844("E2844", "2844", "Velferdsavdelingen"),
