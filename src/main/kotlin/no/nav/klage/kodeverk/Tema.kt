...
enum class Tema(
    ...
    AKT("AKT", "AKT", "Aktivitetsplan med dialoger"),
    ...
    POI("POI", "POI", "Innsyn etter personopplysningsloven"),
    ...
    UKJ("52", "UKJ", "Ukjent"),
    UNG("UNG", "UNG", "Ungdomsprogramytelsen"),
