...
enum class Innsendingsytelse(
    override val id: String,
    override val nbName: String,
) : MinimalCode {
    ...
    FRIVILLIG_MEDLEMSKAP_I_FOLKETRYGDEN_UNDER_OPPHOLD_I_NORGE(
        "FRIVILLIG_MEDLEMSKAP_I_FOLKETRYGDEN_UNDER_OPPHOLD_I_NORGE",
        "Frivillig medlemskap i folketrygden under oppholdi Norge",
    ),
...
class InnsendingsytelseConverter : AttributeConverter<Innsendingsytelse, String?> {
    override fun convertToDatabaseColumn(entity: Innsendingsytelse?): String? = entity?.id

    override fun convertToEntityAttribute(id: String?): Innsendingsytelse? = id?.let { Innsendingsytelse.of(it) }
}
