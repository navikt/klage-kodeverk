...
class TimeUnitTypeConverter : AttributeConverter<TimeUnitType, String?> {
    override fun convertToDatabaseColumn(entity: TimeUnitType?): String? = entity?.id

    override fun convertToEntityAttribute(id: String?): TimeUnitType? = id?.let { TimeUnitType.of(it) }
}
