...
enum class LovKilde(
    ...
    FORSKRIFT_OM_BIDRAGSFORSKOTT_BOSTED_OG_OPPHOLD(
        "64",
        ...
        "Forskrift om bidragsforskott (bosted og opphold)",
    ),
    FORSKRIFT_OM_BIDRAGSFORSKOTT_VED_DELT_BOSTED(
        "65",
        "Forskrift om i hvilke tilfelle det kan ytes bidragsforskott til barn som har delt bosted",
        "Forskrift om bidragsforskott ved delt bosted",
    ),
    FORSKRIFT_OM_BIDRAGSENDRING_FORSKOTTERINGSLOVEN(
        "66",
        ...
        "Forskrift om bidragsendring, forskotteringsloven",
    ),
    FORSKRIFT_OM_INNTEKTSPRØVING_AV_FORSKOTT(
        "67",
    ...
    FORSKRIFT_OM_YTELSER_TIL_GJENLEVENDE_EKTEFELLE_OG_TIDLIGERE_FAMILIEPLEIER(
        "69",
        "Forskrift om ytelser til gjenlevende ektefelle og tidligere familiepleier etter folketrygdloven kapittel 17",
        "Forskrift om ytelser til gjenlevende ektefelle og tidligere familiepleier etter folketrygdloven kapittel 17",
    ),
    FORSKRIFT_OM_GEBYR_FOR_OFFENTLIG_FASTSETTELSE_AV_BARNEBIDRAG(
        "70",
        "Forskrift om gebyr for offentlig fastsettelse av barnebidrag",
        "Forskrift om gebyr for bidragsfastsettelse",
    ),
    ...
    FORSKRIFT_OM_UNGDOMSPROGRAM_OG_UNGDOMSPROGRAMYTELSE(
        "75",
